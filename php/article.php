      ...
      <div class="container text-center">
        ...
        <div class="row g-4" id="resource-container">
          ...
          <div class="col-md-4 resource-item article" data-aos="fade-up">
            <div class="card">
            <img src="../image/r1.jpg" class="card-img-top" alt="Understanding Anxiety"/> 
          ...
          <div class="col-md-4 resource-item article" data-aos="fade-up">
            ...
            <img src="../image/r4.png" class="card-img-top" alt="Understanding Anxiety"/>

              <div class="card-body">
                <h5 class="card-title">Overcoming Stress</h5>
                <p class="card-text">
                Discover how to handle daily stress through mindfulness and effective stress management techniques.
                </p>
                <a
          ...
          <div class="col-md-4 resource-item article" data-aos="fade-up">
            <div class="card">
            <img src="../image/r8.png" class="card-img-top" alt="Understanding Anxiety"/>

            
              <div class="card-body">
                <h5 class="card-title">Urban Mental Health</h5>
                <p class="card-text">
                Learn about the unique challenges of urban living and how to nurture your mental health in a fast-paced world.
                </p>
                <a
          ...
          <div class="col-md-4 resource-item article" data-aos="fade-up">
            <div class="card">
            <img src="../image/r5.png" class="card-img-top" alt="Understanding Anxiety"/>


              <div class="card-body">
                <h5 class="card-title">Work-Life Balance</h5>
                <p class="card-text">
                Explore actionable steps to balance your work and personal life while protecting your mental health.
                </p>
                <a
          ...
          <div class="col-md-4 resource-item article" data-aos="fade-up">
            <div class="card">
            <img src="../image/r7.png" class="card-img-top" alt="Understanding Anxiety"/>

              <div class="card-body">
                <h5 class="card-title">Healthy Relationships</h5>
                <p class="card-text">
                Strong relationships are vital to mental health. Learn how to build and maintain positive connections.
                </p>
                <a
          ...
          <div class="col-md-4 resource-item article" data-aos="fade-up">
            ...
            <img src="../image/r6.png" class="card-img-top" alt="Understanding Anxiety"/>
            
              <div class="card-body">
                <h5 class="card-title">Resilience Building</h5>
                <p class="card-text">
                Discover how to cultivate resilience to handle life's ups and downs with strength and optimism.
                </p>
                <a
